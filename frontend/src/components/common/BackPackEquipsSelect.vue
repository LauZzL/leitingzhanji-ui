<template>
  <div>
    <el-table ref="selectItemRef" :data="filteredItems" style="width: 100%; height: 400px" :show-header="false" @selection-change="handleSelectionChange">
...
const filteredItems = computed(() => {
  return backPackStore.backpack.equips
      .filter(item => item.colorType === props.luckyType)
