  ...
  <div>
    <el-form :inline="true">
      <el-form-item label="购买道具">
        ...
        <el-input type="number" :min="1" :max="32767" v-model="settingStore.setting.endless.buy_num"
                  placeholder="购买数量" style="width: 160px;margin-left: 10px;"
      ...
      <el-form-item label="攻打次数">
        <el-input-number style="width: 100px;" :step="1" :min="1" v-model="settingStore.setting.endless.nums"
                         size="small"
                         placeholder="请输入攻打次数" clearable/>
      </el-form-item>
      <el-form-item label="Timer">
        <el-input-number style="width: 180px;" :step="1" :min="1"
                         v-model="settingStore.setting.endless.attack_timer" size="small"
                         placeholder="请输入整数" clearable/>
      </el-form-item>
      <br>
      <el-form-item label="无尽祝福">
        <el-select v-model="settingStore.setting.endless.zhufu" placeholder="祝福类型" style="width: 100px;"
                   @change="modify('zhufu', settingStore.setting.endless.zhufu)">
          <el-option v-for="item in zhufu_list" :key="item.value" :label="item.name" :value="item.value"/>
        </el-select>
        <el-checkbox @change="modify('enable_zhufu', settingStore.setting.endless.enable_zhufu)"
                     v-model="settingStore.setting.endless.enable_zhufu"
