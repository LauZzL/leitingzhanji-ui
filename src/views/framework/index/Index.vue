  ...
  <div class="framework-index-container">
    <div class="framework-index-desc">
      ...
      <el-text>
        Star 该项目 <el-link type="primary" target="_blank"
          href="https://github.com/LauZzL/leitingzhanji-ui">Github</el-link>
        ，如有任何问题请访问 <el-link type="primary" target="_blank"
          href="https://github.com/LauZzL/leitingzhanji-ui/issues">Github Issues</el-link>
        <br>
        <el-alert style="margin-top: 5px;" type="warning" show-icon :closable="false">部分情况亮色模式下日志输出可能影响阅读，建议使用暗黑模式</el-alert>
      </el-text>
    </div>
    <div class="framework-index-opration">
      <el-card>
        ...
        <el-space>
          <el-button @click="initSunnyNetCore" plain><svg-icon style="width: 16px; height: 16px;"
              iconName="icon-chushihua" />&nbsp;初始化</el-button>
          <el-button @click="closeSunnyNetCore" plain><svg-icon style="width: 16px; height: 16px;"
              iconName="icon-guanbichushihua" />&nbsp;关闭</el-button>
        </el-space>
      </el-card>
    </div>
      ...
      <el-card style="width: 100%">
        ...
        <div class="framework-index-user-left">
          <div class="framework-index-user-left-avatar">
            <el-image fit="fill" style="width: 100%; height: 100%; border-radius: 5px;" :src="userStore?.user?.avatar?userStore?.user?.avatar:'https://cravatar.cn/avatar/?d=wavatar'"></el-image>
          </div>
          <div class="framework-index-user-left-info">
            <el-descriptions border>
              <el-descriptions-item label="昵称">{{ nickname() }}</el-descriptions-item>
              <el-descriptions-item label="VIP">{{ userStore?.user?.vip?userStore?.user?.vip:'未获取到' }}</el-descriptions-item>
